...
class ViewerRenderer:
    def __init__(
        ...
        elif render_depth == True and render_surfel_depth == False:
            self.output_info: Tuple[str, renderers.RendererOutputInfo, renderers.RendererOutputVisualizer] = (
                "depth",
                renderers.RendererOutputInfo("depth"),
                self.depth_map_processor,
            )
        elif render_depth == True and render_surfel_depth == True:
            self.output_info: Tuple[str, renderers.RendererOutputInfo, renderers.RendererOutputVisualizer] = (
                "depth",
                renderers.RendererOutputInfo("surf_depth"),
                self.depth_map_processor,
            )
    ...
    def _setup_depth_map_options(self, viewer, server):
        ...
        print("self.max_depth_gui_number.value",self.max_depth_gui_number.value)
        ...
        print("self.depth_map_color_map_dropdown",self.depth_map_color_map_dropdown.value)
        ...
        with server.gui.add_folder("Output"):
            ...
            def _(event):
                ...
                with server.atomic():
                    ...
                    print("output_type_dropdown.value, output_type_info",output_type_dropdown.value, output_type_info)
    ...
    def depth_map_processor(self, depth_map, *args, **kwargs):
        ...
        return Visualizers.float_colormap(depth_map, "turbo")
