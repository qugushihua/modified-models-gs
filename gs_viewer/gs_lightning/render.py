...
def initializer_viewer_renderer(
    ...
    return ViewerRenderer(model_manager, renderer, torch.tensor(background_color, dtype=torch.float, device=device),render_depth=render_depth,render_surfel_depth=render_surfel_depth)
...
if __name__ == "__main__":
    ...
    # print("args.render_depth", args.render_depth)
    ...
    renderer = initializer_viewer_renderer(
        ...
        render_surfel_depth=args.vanilla_gs2d
    )
